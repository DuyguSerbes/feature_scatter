...
from attack_methods import Attack_FeaScatter, Attack_None, Attack_PGD
...
### UPDATE
parser.add_argument('--model', default='wideresnet', type=str, help='model to be trained')
...
def train_fun(epoch, net):
    ...
    if epoch >= 0:
        ...
        f_path = os.path.join(args.model_dir, 'latest.pt')
        state = {
            'net': net.state_dict(),
            'epoch': epoch,
            'optimizer': optimizer.state_dict()
